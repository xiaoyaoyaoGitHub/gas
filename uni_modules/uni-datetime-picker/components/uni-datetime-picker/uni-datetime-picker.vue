			...
			<slot>
				<view class="uni-date-editor--x"
					...
					<view v-if="!isRange" class="uni-date-x uni-date-single">
						<uni-icons class="icon-calendar" type="calendar" color="#c0c4cc" size="20"></uni-icons>
						<!-- 源代码 是将displayValue 和  singlePlaceholderText 放在一些做或运算，但本小程序需求是placehoder字体颜色不一样，故写成了 v-show 的形式-->
						<view class="uni-date__x-input" v-show="displayValue" style="color: #000;">{{ displayValue }}</view>
						<view class="uni-date__x-input" v-show="!displayValue" style="color: #9c9c9c;">{{ singlePlaceholderText }}</view>
					</view>
